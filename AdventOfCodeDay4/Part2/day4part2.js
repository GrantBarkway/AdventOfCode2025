...
const filePath = 'AdventOfCodeDay4/Part2/adventofcode4_input.txt';
...
let i;
let j;
function remove_rolls(paper_roll_indices) {
    let total_removed = 0;
...
let new_roll_indices;
let removed_prev;
function recursively_remove(paper_roll_indices, total_removed) {
...
console.log(answer);
//# sourceMappingURL=day4part2.js.map